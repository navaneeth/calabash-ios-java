...
public final class Http {
	...
	private String get(String path, Map<String, String> args) throws CalabashException {
		...
		if (args != null && !args.isEmpty()) {
			...
			for (String key : args.keySet()) {
				...
				query.append(String.format("%s%s=%s", firstItem ? "" : "&", utf8URLEncode(key), utf8URLEncode(value)));
				firstItem = false;
			}
		}
